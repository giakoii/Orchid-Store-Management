...
public class OrchidDeleteCommand : AbstractApiRequest, ICommand<CommandResponse>
{
...
/// </summary>
public class OrchidDeleteCommandHandler : ICommandHandler<OrchidDeleteCommand, CommandResponse>
{
    ...
    /// <returns></returns>
    public async Task<CommandResponse> Handle(OrchidDeleteCommand request, CancellationToken cancellationToken)
    {
