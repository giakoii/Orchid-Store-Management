    ...
    public partial class AddOpenIdDict : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    orchid_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    is_natural = table.Column<bool>(type: "boolean", nullable: false),
                    orchid_description = table.Column<string>(type: "text", nullable: true),
                    orchid_name = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    orchid_url = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("orchids_pkey", x => x.orchid_id);
                    table.ForeignKey(
                        name: "fk_category",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    account_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    acount_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_orchid",
                        column: x => x.orchid_id,
                        principalTable: "orchids",
                        principalColumn: "orchid_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_order",
                        column: x => x.order_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orchids_category_id",
                table: "orchids",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "IX_order_details_orchid_id",
                table: "order_details",
                column: "orchid_id");
